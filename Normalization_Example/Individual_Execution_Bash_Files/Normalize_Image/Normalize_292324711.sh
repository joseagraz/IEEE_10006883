...
#$ -l h_vmem=256G
#$ -pe threaded 1
#$ -o SgeDump/Normalize_292324711_$JOB_ID.stdout
#$ -e SgeDump/Normalize_292324711_$JOB_ID.stderr
...
for Enviroment_Loop in {1..10..1}; do # CBICA Cluster may need more than one attempt to load enviroment
       ...
       if [ $? == 0 ]; then                                                                 
           ...
           python Python_Scripts/Normalize_Image.py\
             --Image_To_Normalize         Normalization_Example/Images_and_Maps/Images/292324711.jpg\
